...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        counts = pd.DataFrame(filtered_df['class'].value_counts()).reset_index()
...
@app.callback(Output(component_id='success-payload_scatter-chart', component_property='figure'),
             [Input(component_id='site-dropdown', component_property='value'),
...
def get_scatter_chart(selected_site, slider_values):
    ...
    if selected_site == 'ALL':
        ...
        fig = px.scatter(scatter_df,
                        ...
                        y='class',
                        color='Booster Version Category',
                        title='Payload vs. Success for Site '+selected_site
                        )
        return fig
